...
<?php
	...
	if(isset($_GET['delid'])){
		...
		$time = $_GET['time'];
		$price = $_GET['price'];
		$del_shifted =  $ct->shifted($id, $time, $price);
	}
?>
<?php ?>
        <div class="grid_10">
                ...
                <div class="block">      
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td><a href="customer.php?customerid=<?php echo $result['customer_id'] ?>">Hiển thị người đặt hàng</a></td>
							<td>
								<?php
									if($result['status']==0){
								?>
								...
								<?php
										...
										?>
										<?php
										echo "Đã xác nhận/đang vận chuyển";
										?>
										<?php
										}else{
										?>
