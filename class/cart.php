...
<?php
    ...
    class cart {
        ...
        public function update_quantity_cart($quantity,$cartId){
            ...
            if($result){
                $msg = "<span class='success'>Cập nhật thành công số lượng sản phẩm trong giỏ hàng.</span>";
                return $msg;
            }else{
                $mgs = "<span class='error'>Cập nhật số lượng không thành công số lượng sản phẩn trong giỏ hàng.</span>";
                return $mgs;
            }
        }  
        public function del_product_cart($cartid){
            ...
            if($result){
                ...
                $mgs = "<span class='error'>Chưa xoá sản phẩm trong giỏ hàng.</span>";
                return $mgs;
            }
        }
        ...
        public function shifted($id, $time, $price){
            ...
            if($result){
                ...
                $mgs = "<span class='error'>Cập nhật không thành.</span>";
                return $mgs;
            }
        }
        ...
        public function del_shifted($id, $time, $price){
            ...
            if($result){
                ...
                $mgs = "<span class='error'>Xóa không thành.</span>";
                return $mgs;
            }
        }
